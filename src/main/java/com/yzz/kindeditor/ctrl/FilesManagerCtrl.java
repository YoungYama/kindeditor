package com.yzz.kindeditor.ctrl;
...
@WebServlet(urlPatterns = "/kindeditor/file/manager")
public class FilesManagerCtrl extends HttpServlet {

	private static final long serialVersionUID = 3807261300209908013L;
